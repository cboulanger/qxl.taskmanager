  ...
  qx.Class.define("qx.html.Element", {
    ...
    */
    ...
    construct: function construct(tagName, styles, attributes) {
      ...
      this.__P_73_0 = tagName || "div";
      this.__P_73_1 = styles || null;
      this.__P_73_2 = attributes || null;
    },
      ...
      */
      ...
      flush: function flush() {
        ...
        for (var hc in modified) {
          ...
          if (obj.__P_73_10() || obj.classname == "qx.html.Iframe") {
            // Separately queue rendered elements
            if (obj.__P_73_11 && qx.dom.Hierarchy.isRendered(obj.__P_73_11)) {
              later.push(obj);
        ...
        for (var hc in visibility) {
          ...
          if (!obj.$$disposed) {
            element.style.display = obj.__P_73_13 ? "" : "none"; // also hide the element (fixed some rendering problem in IE<8 & IE8 quirks)

            if (qx.core.Environment.get("engine.name") == "mshtml") {
              if (!(document.documentMode >= 8)) {
                element.style.visibility = obj.__P_73_13 ? "visible" : "hidden";
              }
            }
          }
        ...
        for (var hc in scroll) {
          obj = scroll[hc];
          var elem = obj.__P_73_11;

          if (elem && elem.offsetWidth) {
            var done = true; // ScrollToX

            if (obj.__P_73_14 != null) {
              obj.__P_73_11.scrollLeft = obj.__P_73_14;
              delete obj.__P_73_14;
            } // ScrollToY


            if (obj.__P_73_15 != null) {
              obj.__P_73_11.scrollTop = obj.__P_73_15;
              delete obj.__P_73_15;
            } // ScrollIntoViewX


            var intoViewX = obj.__P_73_16;
        ...
        for (var i = 0; i < this._actions.length; i++) {
          ...
          var element = action.element.__P_73_11;

          if (!element || !activityEndActions[action.type] && !action.element.__P_73_10()) {
            continue;
          }
        ...
        for (var hc in this.__P_73_3) {
          ...
          var elem = selection.element.__P_73_11;
      ...
      __P_73_8: function __P_73_8(domElement) {
        ...
        return element && !element.__P_73_10();
      },
    ...
    members: {
      ...
      */
      ...
      _createDomElement: function _createDomElement() {
        return qx.dom.Element.create(this.__P_73_0);
      },
      ...
      connectWidget: function connectWidget(widget) {
        this.__P_73_18 = widget;

        if (this.__P_73_11) {
          this.__P_73_11.$$widget = widget.toHashCode();
          this.__P_73_11.$$widgetObject = widget;
        }
      ...
      disconnectWidget: function disconnectWidget(widget) {
        delete this.__P_73_18;

        if (this.__P_73_11) {
          this.__P_73_11.$$widget = "";
          delete this.__P_73_11.$$widgetObject;
        }
       ...
       */
      __P_73_29: function __P_73_29(domElement) {
        ;
        this.__P_73_11 = domElement;
        domElement.$$elementObject = this;
        domElement.$$element = this.toHashCode();

        if (this.__P_73_18) {
          domElement.$$widget = this.__P_73_18.toHashCode();
          domElement.$$widgetObject = this.__P_73_18;
        }
      },
      ...
      __P_73_12: function __P_73_12() {
        ...
        if (children) {
          ...
          for (var i = 0; i < length; i++) {
            ...
            if (child.__P_73_13 && child.__P_73_20 && !child.__P_73_11) {
              child.__P_73_12();
            }
          }
        }
        ...
        if (!this.__P_73_11) {
          this.__P_73_29(this._createDomElement());
      ...
      */
      ...
      _insertChildren: function _insertChildren() {
        ...
        if (length > 2) {
          ...
          for (var i = 0; i < length; i++) {
            ...
            if (child.__P_73_11 && child.__P_73_20) {
              domElement.appendChild(child.__P_73_11);
            }
          }

          this.__P_73_11.appendChild(domElement);
        } else {
          var domElement = this.__P_73_11;
      ...
      _syncChildren: function _syncChildren() {
        var dataChildren = this.__P_73_26;
        var dataLength = dataChildren.length;
        var dataChild;
        var dataEl;
        var domParent = this.__P_73_11;
        ...
        for (var i = domChildren.length - 1; i >= 0; i--) {
          ...
          if (!dataEl || !dataEl.__P_73_20 || dataEl.__P_73_28 !== this) {
        ...
        for (var i = 0; i < dataLength; i++) {
          ...
          if (dataChild.__P_73_20) {
            dataEl = dataChild.__P_73_11;
      ...
      */
      updateObjectId: function updateObjectId() {
        ...
        if (qx.core.Environment.get("module.objectid")) {
          ...
          if (this.__P_73_18 && this.__P_73_18.getQxObjectId()) {
            id = qx.core.Id.getAbsoluteIdOf(this.__P_73_18, true) || null;
          }
      ...
      _copyData: function _copyData(fromMarkup) {
        var elem = this.__P_73_11; // Copy attributes

        var data = this.__P_73_2;
      ...
      _syncData: function _syncData() {
        var elem = this.__P_73_11;
        var Attribute = qx.bom.element.Attribute;
        var Style = qx.bom.element.Style; // Sync attributes

        var jobs = this.__P_73_22;
      ...
      */
       ...
       *     of this element
       */
      __P_73_30: function __P_73_30(child) {
        if (child.__P_73_28 === this) {
        ...
        if (child.__P_73_28) {
          child.__P_73_28.remove(child);
        } // Convert to child of this object


        child.__P_73_28 = this; // Prepare array
       ...
       *     of this element
       */
      __P_73_31: function __P_73_31(child) {
        if (child.__P_73_28 !== this) {
       ...
       *     of this element
       */
      __P_73_32: function __P_73_32(child) {
        if (child.__P_73_28 !== this) {
          throw new Error("Has no child: " + child);
        } // Schedule children update
      ...
      */
      ...
      add: function add(varargs) {
        if (arguments[1]) {
          for (var i = 0, l = arguments.length; i < l; i++) {
            this.__P_73_30(arguments[i]);
          }

          this.__P_73_26.push.apply(this.__P_73_26, arguments);
        } else {
          this.__P_73_30(varargs);

          this.__P_73_26.push(varargs);
        } // Chaining support
      ...
      addAt: function addAt(child, index) {
        this.__P_73_30(child);

        qx.lang.Array.insertAt(this.__P_73_26, child, index); // Chaining support
      ...
      remove: function remove(childs) {
        ...
        if (arguments[1]) {
          ...
          for (var i = 0, l = arguments.length; i < l; i++) {
            ...
            this.__P_73_31(child);

            qx.lang.Array.remove(children, child);
          }
        } else {
          this.__P_73_31(childs);
      ...
      removeAt: function removeAt(index) {
        ...
        qx.lang.Array.removeAt(this.__P_73_26, index); // Chaining support
      ...
      */
      ...
      insertInto: function insertInto(parent, index) {
        parent.__P_73_30(this);

        if (index == null) {
          parent.__P_73_26.push(this);
        } else {
          qx.lang.Array.insertAt(this.__P_73_26, this, index);
        }
      ...
      insertBefore: function insertBefore(rel) {
        var parent = rel.__P_73_28;

        parent.__P_73_30(this);

        qx.lang.Array.insertBefore(parent.__P_73_26, this, rel);
        return this;
      },
      ...
      insertAfter: function insertAfter(rel) {
        ...
        qx.lang.Array.insertAfter(parent.__P_73_26, this, rel);
        return this;
      },
      ...
      moveTo: function moveTo(index) {
        var parent = this.__P_73_28;

        parent.__P_73_32(this);

        var oldIndex = parent.__P_73_26.indexOf(this);
        ...
        qx.lang.Array.removeAt(parent.__P_73_26, oldIndex);
        qx.lang.Array.insertAt(parent.__P_73_26, this, index);
        return this;
      },
      ...
      moveBefore: function moveBefore(rel) {
        var parent = this.__P_73_28;
        return this.moveTo(parent.__P_73_26.indexOf(rel));
      },
      ...
      moveAfter: function moveAfter(rel) {
        var parent = this.__P_73_28;
        return this.moveTo(parent.__P_73_26.indexOf(rel) + 1);
      },
      ...
      free: function free() {
        ...
        parent.__P_73_31(this);

        qx.lang.Array.remove(parent.__P_73_26, this);
        return this;
      },
      ...
      */
      ...
      useElement: function useElement(elem) {
        ...
        this.__P_73_29(elem); // Copy currently existing data over to element
      ...
      isFocusable: function isFocusable() {
        ...
        if (tabIndex >= 0 && focusable[this.__P_73_0]) {
          return true;
        }
      ...
      isNativelyFocusable: function isNativelyFocusable() {
        return !!qx.event.handler.Focus.FOCUSABLE_ELEMENTS[this.__P_73_0];
      },
      ...
      */
      ...
      include: function include() {
        ...
        delete this.__P_73_20;

        if (this.__P_73_28) {
          this.__P_73_28._scheduleChildrenUpdate();
        }
      ...
      */
      ...
      disableScrolling: function disableScrolling() {
        ...
        this.scrollToX(0);
        this.scrollToY(0);
        this.addListener("scroll", this.__P_73_33, this);
      },
      ...
      enableScrolling: function enableScrolling() {
        this.removeListener("scroll", this.__P_73_33, this);
      },
      __P_73_34: null,
       ...
       */
      __P_73_33: function __P_73_33(e) {
        if (!this.__P_73_34) {
          this.__P_73_34 = true;
          this.__P_73_11.scrollTop = 0;
          this.__P_73_11.scrollLeft = 0;
          delete this.__P_73_34;
        }
      },
      ...
      */
       ...
       */
      __P_73_35: function __P_73_35(action, args) {
      ...
      capture: function capture(containerCapture) {
        this.__P_73_35("capture", [containerCapture !== false]);
      },
      ...
      */
      ...
      setStyle: function setStyle(key, value, direct) {
        ...
        if (this.__P_73_11) {
          ...
          if (direct) {
            qx.bom.element.Style.set(this.__P_73_11, key, value);
            return this;
          ...
          this.__P_73_21[key] = true; // Register modification
      ...
      setStyles: function setStyles(map, direct) {
        ...
        if (this.__P_73_11) {
          ...
          for (var key in map) {
            ...
            if (direct) {
              Style.set(this.__P_73_11, key, value);
              continue;
            } // Store job info


            this.__P_73_21[key] = true;
      ...
      */
      ...
      setAttribute: function setAttribute(key, value, direct) {
        ...
        if (this.__P_73_2[key] == value) {
          return this;
        }

        if (value == null) {
          delete this.__P_73_2[key];
        } else {
          this.__P_73_2[key] = value;
        } // Uncreated elements simply copy all data
        // on creation. We don't need to remember any
        // jobs. It is a simple full list copy.
        ...
        if (this.__P_73_11) {
          // Omit queuing in direct mode
          if (direct) {
            qx.bom.element.Attribute.set(this.__P_73_11, key, value);
            return this;
          } // Dynamically create if needed
          ...
          this.__P_73_22[key] = true; // Register modification
      ...
      getAttribute: function getAttribute(key) {
        return this.__P_73_2 ? this.__P_73_2[key] : null;
      },
      ...
      */
      ...
      _setProperty: function _setProperty(key, value, direct) {
        ...
        if (this.__P_73_24[key] == value) {
          return this;
        }

        if (value == null) {
          delete this.__P_73_24[key];
        } else {
          this.__P_73_24[key] = value;
        } // Uncreated elements simply copy all data
        // on creation. We don't need to remember any
        // jobs. It is a simple full list copy.
        ...
        if (this.__P_73_11) {
          ...
          this.__P_73_23[key] = true; // Register modification
      ...
      */
      ...
      addListener: function addListener(type, listener, self, capture) {
        ...
        if (this.__P_73_11) {
          return qx.event.Registration.addListener(this.__P_73_11, type, listener, self, capture);
        }
      ...
      removeListener: function removeListener(type, listener, self, capture) {
        ...
        if (this.__P_73_11) {
          ...
          qx.event.Registration.removeListener(this.__P_73_11, type, listener, self, capture);
        } else {
          var values = this.__P_73_25;
          var entry;
      ...
      removeListenerById: function removeListenerById(id) {
        ...
        if (this.__P_73_11) {
          qx.event.Registration.removeListenerById(this.__P_73_11, id);
        } else {
          delete this.__P_73_25[id];
        }
      ...
      hasListener: function hasListener(type, capture) {
        ...
        if (this.__P_73_11) {
          return qx.event.Registration.hasListener(this.__P_73_11, type, capture);
        }
      ...
      getListeners: function getListeners() {
        ...
        if (this.__P_73_11) {
          return qx.event.Registration.getManager(this.__P_73_11).serializeListeners(this.__P_73_11);
        }

        var listeners = [];

        for (var id in this.__P_73_25) {
          var listenerData = this.__P_73_25[id];
          listeners.push({
    ...
    */
    destruct: function destruct() {
      ...
      this._disposeArray("__P_73_26");

      this.__P_73_2 = this.__P_73_1 = this.__P_73_25 = this.__P_73_24 = this.__P_73_22 = this.__P_73_21 = this.__P_73_23 = this.__P_73_11 = this.__P_73_28 = this.__P_73_16 = this.__P_73_17 = null;
    }
  });
  qx.html.Element.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Element.js.map?dt=1595098504546