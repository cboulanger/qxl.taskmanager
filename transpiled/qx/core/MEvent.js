  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.core.MEvent", {
    members: {
      ...
      __P_56_0: qx.event.Registration,
      ...
      addListener: function addListener(type, listener, self, capture) {
        if (!this.$$disposed) {
          return this.__P_56_0.addListener(this, type, listener, self, capture);
        }
      ...
      removeListener: function removeListener(type, listener, self, capture) {
        if (!this.$$disposed) {
          ...
          return this.__P_56_0.removeListener(this, type, listener, self, capture);
        }
      ...
      removeListenerById: function removeListenerById(id) {
        if (!this.$$disposed) {
          return this.__P_56_0.removeListenerById(this, id);
        }
      ...
      hasListener: function hasListener(type, capture) {
        return this.__P_56_0.hasListener(this, type, capture);
      },
      ...
      dispatchEvent: function dispatchEvent(evt) {
        if (!this.$$disposed) {
          return this.__P_56_0.dispatchEvent(this, evt);
        }
      ...
      fireEvent: function fireEvent(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_56_0.fireEvent(this, type, clazz, args);
        }
      ...
      fireNonBubblingEvent: function fireNonBubblingEvent(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_56_0.fireNonBubblingEvent(this, type, clazz, args);
        }
      ...
      fireDataEvent: function fireDataEvent(type, data, oldData, cancelable) {
        if (!this.$$disposed) {
          ...
          return this.__P_56_0.fireEvent(this, type, qx.event.type.Data, [data, oldData, !!cancelable]);
        }
...
//# sourceMappingURL=MEvent.js.map?dt=1595453720076