    ...
    */
    statics: {
      ...
      createHashCode: function createHashCode() {
        var hash = String(this.__P_54_1++ + this.__P_54_2);
        return hash;
      },
      ...
      fromHashCode: function fromHashCode(hash, suppressWarnings) {
        var obj = this.__P_54_0[hash] || null;
...
//# sourceMappingURL=ObjectRegistry.js.map?dt=1595104505397