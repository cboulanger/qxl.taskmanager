    ...
    statics: {
      ...
      stringToRgb: function stringToRgb(str) {
        ...
        if (this.isNamedColor(str)) {
          ...
          return this.__P_107_0(str);
        } else if (this.isRgbString(str)) {
          return this.__P_107_1();
        } else if (this.isHex3String(str)) {
          return this.__P_107_2();
...
//# sourceMappingURL=ColorUtil.js.map?dt=1595098507630