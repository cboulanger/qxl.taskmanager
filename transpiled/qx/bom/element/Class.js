    ...
    statics: {
      ...
      addClasses: {
        ...
        "default": function _default(element, classes) {
          ...
          if (old) {
            result = old.split(this.__P_158_0);
      ...
      removeClasses: {
        ...
        "default": function _default(element, classes) {
          ...
          return element.className = element.className.replace(reg, "").replace(this.__P_158_1, "").replace(this.__P_158_0, " ");
        }
      }[qx.core.Environment.get("html.classlist") ? "native" : "default"],
...
//# sourceMappingURL=Class.js.map?dt=1595453728913