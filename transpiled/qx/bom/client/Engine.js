  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_34_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_34_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_34_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_34_3()) {
      ...
      __P_34_0: function __P_34_0() {
        ...
        if (qx.bom.client.Engine.__P_34_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1595453607080