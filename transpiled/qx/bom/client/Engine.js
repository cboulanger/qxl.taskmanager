  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_38_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_38_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_38_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_38_3()) {
      ...
      __P_38_0: function __P_38_0() {
        ...
        if (qx.bom.client.Engine.__P_38_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1595098500375