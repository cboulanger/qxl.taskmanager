  ...
  qx.Class.define("qx.ui.layout.VBox", {
    ...
    */
    members: {
      ...
      */
       ...
       */
      __P_4_4: function __P_4_4() {
        var children = this._getLayoutChildren();

        var length = children.length;
        var enableFlex = false;
        var reuse = this.__P_4_0 && this.__P_4_0.length != length && this.__P_4_1 && this.__P_4_0;
        var props; // Sparse array (keep old one if lengths has not been modified)

        var heights = reuse ? this.__P_4_0 : new Array(length);
        var flexs = reuse ? this.__P_4_1 : new Array(length); // Reverse support
        ...
        if (!reuse) {
          this.__P_4_0 = heights;
          this.__P_4_1 = flexs;
        }

        this.__P_4_2 = enableFlex;
        this.__P_4_3 = children; // Clear invalidation marker
      ...
      */
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        if (this.__P_4_2 && allocatedHeight != availHeight) {
          var flexibles = {};
          var flex, offset;
      ...
      _computeSizeHint: function _computeSizeHint() {
        ...
        var children = this.__P_4_3; // Initialize
        ...
        for (var i = 0, l = children.length; i < l; i += 1) {
          ...
          var flex = this.__P_4_1[i];
          var percent = this.__P_4_0[i];
    ...
    */
    destruct: function destruct() {
      this.__P_4_0 = this.__P_4_1 = this.__P_4_3 = null;
    }
  });
  qx.ui.layout.VBox.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=VBox.js.map?dt=1595104499852