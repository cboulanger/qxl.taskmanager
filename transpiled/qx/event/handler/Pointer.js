  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.handler.Pointer", {
    ...
    construct: function construct(manager) {
      // Define shorthands
      this.__P_131_0 = manager;
      this.__P_131_1 = manager.getWindow();
      this.__P_131_2 = this.__P_131_1.document;
      qx.event.handler.PointerCore.apply(this, [this.__P_131_2]);
    },
    members: {
      __P_131_0: null,
      __P_131_1: null,
        ...
        if (target && target.nodeType) {
          ...
          qx.event.Utils.then(tracker, function () {
            if ((domEvent.getPointerType() !== "mouse" || domEvent.button <= qx.event.handler.PointerCore.LEFT_BUTTON) && (type == "pointerdown" || type == "pointerup" || type == "pointermove" || type == "pointercancel")) {
              return qx.event.Registration.fireEvent(self.__P_131_2, qx.event.handler.PointerCore.POINTER_TO_GESTURE_MAPPING[type], qx.event.type.Pointer, [domEvent, target, null, false, false]);
            }
          });
          qx.event.Utils.then(tracker, function () {
            // Fire user action event
            return qx.event.Registration.fireEvent(self.__P_131_1, "useraction", qx.event.type.Data, [type]);
          });
      ...
      dispose: function dispose() {
        this.__P_131_3("dispose");

        this.__P_131_0 = this.__P_131_1 = this.__P_131_2 = null;
      },
       ...
       */
      __P_131_3: function __P_131_3(method, args) {
...
//# sourceMappingURL=Pointer.js.map?dt=1595104511541