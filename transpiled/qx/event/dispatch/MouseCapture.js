  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.dispatch.MouseCapture", {
    ...
    construct: function construct(manager, registration) {
      ...
      this.__P_84_0 = manager.getWindow();
      this.__P_84_1 = registration;
      manager.addListener(this.__P_84_0, "blur", this.releaseCapture, this);
      manager.addListener(this.__P_84_0, "focus", this.releaseCapture, this);
      manager.addListener(this.__P_84_0, "scroll", this.releaseCapture, this);
    },
    statics: {
    ...
    members: {
      ...
      */
      ...
      canDispatchEvent: function canDispatchEvent(target, event, type) {
        return !!(this.__P_84_2 && this.__P_84_4[type]);
      },
      // overridden
      dispatchEvent: function dispatchEvent(target, event, type) {
        ...
        if (this.__P_84_3 || !qx.dom.Hierarchy.contains(this.__P_84_2, target)) {
          target = this.__P_84_2;
        }
      ...
      */
      ...
      activateCapture: function activateCapture(element, containerCapture) {
        ...
        if (this.__P_84_2 === element && this.__P_84_3 == containerCapture) {
          return;
        }
        ...
        this.__P_84_3 = containerCapture;
        this.__P_84_2 = element;

        this.__P_84_1.fireEvent(element, "capture", qx.event.type.Event, [true, false]);
      },
      ...
      releaseCapture: function releaseCapture() {
        ...
        this.__P_84_1.fireEvent(element, "losecapture", qx.event.type.Event, [true, false]); // turn off native mouse capturing if the browser supports it
...
//# sourceMappingURL=MouseCapture.js.map?dt=1595098505395